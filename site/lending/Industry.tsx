...
const Industry = ()=>{
  return(
    <Box background={theme.colors.beige}>
      ...
      <Box width={'1335px'} margin={'0 auto'} display={'flex'} alignItems={'center'} position={'relative'} zIndex={1}>
        <div>
          <WavesL height={10} width={80} stroke={theme.colors.dark}/>
        ...
        <Box width={'1100px'} height={'600px'} display={'flex'} alignItems={'center'} position={'relative'} zIndex={5} >
          <Box border={`5px solid ${theme.colors.white}`} width={'180px'} height={'180px'} borderRadius={'5px'} textAlign={'center'} background={theme.colors.beige} >
            <DivMargin height='30px'/>
        ...
        <Box position={'absolute'} top={'160px'} left={'303px'} zIndex={0}>
          <WavesXL width={'810px'} height={'289px'} fill={'none'}/>
        </Box>
      </Box>
      <DivMargin height='100px'/>
    </Box>
